...
main:
	...
	clr		R12							; box in top corner with 0,0
	clr		R13
	mov.w	#0x34, R12					; left location of center LCD
	mov.w	#0x03, R13					; top location of center LCD (Close enough to center)
...
draw:
	mov		#NOKIA_DATA, R12
	mov		#0xFF, R13					; 0xFF is sold line
	call	#writeNokiaByte
...
setAddress:
	...
	mov.w	#NOKIA_CMD, R12		; Write a command, setup call to
